                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-menu">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="#features">¿Quiénes somos?</a></li>
                            <li><a href="#business">Cursos</a></li>
                            <li><a href="#product">Compra Regional</a></li>

                            <li><a href="#test">Cultura Emprendedora</a></li>
                            <li><a href="#test">Noticias</a></li>
                            <li><a href="#action">Revista</a></li>
                            <li><a href="#test">Voluntariado</a></li>
                            <li><a href="#contact">Dona</a></li>
                        </ul>
                    </div><!-- /.navbar-collapse -->
                </div>
                        ...
                        <div class="main_home text-center">
                            <div class="col-md-12">
                                <div class="hello_slid">
                                    <div class="slid_item">
                                        <div class="home_text ">
                                            {{-- <h2 class="text-white">Bienvenido a <strong>Fundación</strong></h2> --}}
                                            <h1 class="text-white">Las cadenas de la esclavitud solamente atan las manos: es la mente lo que hace al hombre libre o esclavo.</h1>
                                            <h3 class="text-white">Franz Grillparzer (1791-1872) Dramaturgo austriaco.</h3>
                                        </div>
                                    ...
                                    <div class="slid_item">
                                        <div class="home_text ">
                                            <h1 class="text-white">La libertad de expresión es decir lo que la gente no quiere oír.</h1>
                                            <h3 class="text-white">George Orwell (1903-1950) Escritor británico.</h3>
                                        </div>
                                    ...
                                    <div class="slid_item">
                                        <div class="home_text ">
                                            <h1 class="text-white">La paz comienza con una sonrisa.</h1>
                                            <h3 class="text-white">Madre Teresa de Calcuta (1910-1997) Misionera de origen albanés naturalizada india</h3>
                                        </div>
                        ...
                        <div class="main_business">
                                    ...
                                    <div class="business_items text-center">
                                        <div class="business_item">
                                            <div class="business_img">
                                                <img src="assets/images/salud.jpg" alt="" />
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="business_item sm-m-top-50">
                                    <h2 class="text-uppercase"><strong>Fundación</strong> Cursos</h2>
                                    <ul>
                                        <li><i class="fa fa-arrow-circle-right"></i> Curso 1 </li>
                                        <li><i class="fa  fa-arrow-circle-right"></i> Curso 2 </li>
                                        <li><i class="fa  fa-arrow-circle-right"></i> Curso N </li>
                                    </ul>
                                    <p class="m-top-20">
                                        Desde nuestro lugar entendemos el reto que representa para las personas acceder a distintintas fuentes de capacitación, por esto
                                        ofrecemos a la comunidad distintintos cursos bla bla bla
                                    </p>

                                    <div class="business_btn">
                                        <a href="{{route('curses')}}" class="btn btn-default m-top-20">Ver los cursos</a>
                                        {{-- <a href="" class="btn btn-primary m-top-20">Buy Now</a> --}}
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="main_test fix">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="head_title text-center fix">
                                    <h2 class="text-uppercase">Contamos con un programa de voluntariado</h2>
                                    <h5>Conocé los testimonios</h5>
                                </div>
                            </div>
                           ...
                           <form action="">
                            <div class="col-md-6">
                                <div class="action_item text-center">
                                    ...
                                    <h4 class="text-white text-uppercase">Suscribite a nuestra revista</h4>
                                </div>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="widget_area">
                            ...
                            <div class="col-md-3">
                                <div class="widget_item widget_latest sm-m-top-50">
                                    <h5 class="text-white">Cursos más populares</h5>
                            ...
                            <div class="col-md-3">
                                <div class="widget_item widget_service sm-m-top-50">
                                    <h5 class="text-white">Últimas noticas</h5>
                                    <ul class="m-top-20">
                            ...
                            <div class="col-md-3">
                                <div class="widget_item widget_newsletter sm-m-top-50">
                                    <h5 class="text-white">Nos contactamos</h5>
                ...
                <div class="main_footer fix bg-mega text-center p-top-40 p-bottom-30 m-top-80">
                    <div class="col-md-12">
                        <p class="wow fadeInRight" data-wow-duration="1s">
                            ...
                            <a target="_blank" href="https://bootstrapthemes.co"> ??publi??? </a>
